...
public class VhdlFactory {
	...
	public VhdlFactory(String Template) {
	...
	public String CreateComponent(String TemplateFile) {
		String component = "";
		if (TemplateFile != "Blank") {
			Map<String, String> tags = ReadTags(TemplateFile);
